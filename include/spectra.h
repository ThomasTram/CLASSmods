...
struct spectra {
  ...
  int index_tr_delta_inu;    /**< index of first species of interacting neutrino density transfer function */
  ...
  int index_tr_theta_inu;    /**< index of first species of interacting neutrino velocity transfer function */
