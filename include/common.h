...
struct precision
{
  ...
  /**
   * parameter controlling relative precision of integrals over inu
   * phase-space distribution during perturbation calculation
   */
  double tol_inu;
  double tol_inu_newtonian;
  double tol_inu_synchronous;
  ...
  int l_max_ncdm;   /**< number of momenta in Boltzmann hierarchy for relativistic neutrino/relics (scalar), at least 4 */
   int l_max_inu;   /**< number of momenta in Boltzmann hierarchy for relativistic interacting neutrino/relics (scalar), at least 4 */
